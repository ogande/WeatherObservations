...
object ProcessTemperatureData {
  ...
  /** Converting the raw temperature data from 1756 to 1858 in the required format
   *  
  ...
  /** Converting the raw temperature data from 1859 to 1960 in the required format
   *  
   *  @param path of the file, required format ( e.g. AVRO/Parquet) and the destination path, default is blank, all are of String type
   *  @return Unit - nothing but void, in scala it is Unit
   */
  ...
  /** Converting the raw temperature data from 1961 to 2017 in the required format
   *  
   *  @param path of the file, required format ( e.g. AVRO/Parquet) and the destination path, default is blank, all are of String type
   *  @return Unit - nothing but void, in scala it is Unit
   */
  def From1961To2017(inputPath:String,requiredFormat:String, destPath:String = "") = {
    try{
      ...
      if(inputLengths.contains(inputRDD1.first.length)){ 
  ...
  /** Unifies all the temperature data from 1756 to 2017
   *  
